                  ...
                  <div className={styles.depositWarning}>
                    <p className={styles.reviewYourOffer}>
                      *Review your offer carefully as this action isn’t
                      reversible. You won’t be able to edit the description of
                      the job, you will be able to add tasks further on paying
                      an small fee. Check docs for further information.
                    </p>
